...
/**
 * Servlet implementation class SingerAddController
 */
@WebServlet("/SingerAddController")
public class SingerAddController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (!ServletFileUpload.isMultipartContent(request)) {
			...
			request.setAttribute("link", "admin/add/singers");
		...
		try {
			...
			Singer singer = new Singer(category, country, nameSinger, keyWord, slugSinger, infoSinger, linkImg, 0, null,
					null, null, null);
